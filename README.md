...
| llama.cpp `prop.integrated` regression produces plausible-looking wrong output | `patches/llamacpp/0001` | bisected to c7d8722 |
| llama.cpp KQV fp16 accumulation corrupts at long context | `patches/llamacpp/0002` | fixed here, not upstream |
| gfx1013 missing from llama.cpp's RDNA1 macro: garbled generation, quantized kernels 9.2x slow | `patches/llamacpp/0003` | fixed here, not upstream |
