...
That widening is the point. Patch headers carry figures too, so they are checked here as well. Some
misses are legitimate (derived means, percentages, a DOI), so the
