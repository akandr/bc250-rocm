...
#
# The write-up and the patch header both state that with upstream
...
# by no surviving log, and it is the load-bearing number in that patch,
# so it is measured again rather than kept as remembered.
#
